...
export interface RatingsSummary {
  ...
  foodHygiene?: number // 0-5 rating, only for food establishments
  bookingCom?: number // Only for hotels
}
...
export interface Business {
  ...
  gallery: GalleryImage[] // Gallery images with source metadata
  coordinates: {
    lat: number
    lng: number
  }
...
export const businesses: Business[] = [
  ...
  },
  {
    ...
    description: "Award-winning hair salon known for effortless, modern cuts and expert colour work.",
  ...
  },
  {
    ...
    description: "Celebrity hotspot in a converted fire station serving American-inspired cuisine.",
  ...
  },
  {
    ...
    description: "Luxury fitness club with world-class facilities, pools, and expert personal trainers.",
  ...
  },
  {
    ...
    description: "Luxury nail salon and brow bar favoured by influencers and celebrities alike.",
    ...
    coordinates: { lat: 51.5107, lng: -0.1460 },
    priceLevel: "£££",
  ...
  },
  {
    ...
    reviewCount: 1123,
    location: "Fitzrovia, London",
    description: "Australian-style cafe serving some of London's best coffee and brunch dishes.",
  ...
  },
  {
    ...
    description: "Premium fitness club with cutting-edge equipment and exclusive group classes.",
